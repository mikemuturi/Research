...
import Surveyspage from "@/components/isp/surveys/page";
import Submissionspage from "@/components/isp/submissions/page";
import Resultspage from "@/components/isp/results/page";
import Userspage from "@/components/isp/users/page";
import Assessmentpage from "@/components/isp/assessment/page";
import Settingspage from "@/components/isp/settings/page";
...
const mainTabs = [
  ...
  { name: "Assessment", icon: CheckCircle, component: <Assessmentpage /> },
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6 font-bold text-lg">ISP Dashboard</div>
